...
# Disabled: select statement has grammar bug causing parse errors
...
list="Apple Banana Cherry Quit"

select fruit in $list; do
...
# 1. Subscript (array indexing)
arr=(a b c)
arr[1]=value
echo ${arr[1]}

# 2. Coprocess statement
coproc myproc { sleep 10;
}

# 3. Repeat statement (Zsh-specific)
repeat 3 do
echo "repeated"
done

# 4. Terse for statement
for x( a b c)echo ${x}
