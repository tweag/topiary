        ...
        <div className="App">
            ...
            <div className="columns">
                <div className="column">
                    <h1>Query</h1>
                    <Editor id="query" value={query} language="tree-sitter-query" onChange={s => { setQuery(s); queryChanged.current = true; }} placeholder="Enter your query here ..." />
                </div>
                <div className="column">
                    <h1>Input</h1>
                    <Editor id="input" value={input} language={currentLanguage} onChange={s => setInput(s)} placeholder="Enter your input here ..." />
                </div>
                <div className="column">
                    <h1>Output</h1>
                    <Editor id="output" value={output} language={currentLanguage} readOnly placeholder="The formatted code will appear here ..." />
