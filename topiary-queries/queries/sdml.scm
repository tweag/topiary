...
(module
 ...
 version_uri: (iri)? @append_space) @allow_blank_line_before
...
(environment_def
 "def" @append_space
 name: (identifier) @append_space) @allow_blank_line_before @append_hardline
...
(function_cardinality_expression
 ...
 uniqueness: (_)? @append_space) @append_space
...
(property_ref
 "ref" @append_space
 property: (identifier_reference) @append_space) @allow_blank_line_before
